Array.transform = (function Array$transform$(f, a, r = a) {
    /* Array.transform eval.sibilant:2:0 */
...
Array.prototype.each = (function Array$prototype$each$(f) {
    /* Array.prototype.each eval.sibilant:18:0 */

    this.forEach(f);
    return this;
});
Array.prototype.bind = (function Array$prototype$bind$(f) {
    /* Array.prototype.bind eval.sibilant:21:0 */
...
Map.prototype.each = (function Map$prototype$each$(f) {
    /* Map.prototype.each eval.sibilant:24:0 */
